...
export const urls = {
	...
	GEO_CLOUD: {
		...
		LEAVE_ADMIN_ROLE: services.GEO_CLOUD + "api/leave/role",
		PENDING_APPROVAL: services.GEO_CLOUD + "social-cloud/pending-approvals",
		ADMIN_VERIFICATION: services.GEO_CLOUD + "social-cloud/admin/verification",
		REMOVE_ADMIN_REQUEST: services.GEO_CLOUD + "api/removeAdmin/request/filter",
		APPROVE_REMOVE_ADMIN_REQUEST: services.GEO_CLOUD + "api/removeAdmin/approve/",
		REJECT_REMOVE_ADMIN_REQUEST: services.GEO_CLOUD + "api/removeAdmin/reject/",
		...
		REQUEST_COMMUNITY_FILTER: services.GEO_CLOUD + "request-community/filter",
		REQUEST_COMMUNITY_APPROVE: services.GEO_CLOUD + "request-community/approve",
		REQUEST_COMMUNITY_REJECT: services.GEO_CLOUD + "request-community/reject",
		COMMUNITY_BY_USER_ID: services.GEO_CLOUD + "community/byUserId",
		CREATE_THOUGHTS: services.GEO_CLOUD + "thoughts",
		FILTER_THOUGHTS: services.GEO_CLOUD + "thoughts/filter",
