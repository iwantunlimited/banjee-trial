                ...
                <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}>
                    ...
                    <div style={{display:'flex',width: '100%',justifyContent: 'space-between'}}>
                        <div style={{display:'flex',alignItems: 'center'}}>
                            <img src={Logo} style={{ width: window.innerWidth <520 ? '80px' : '110px' }} alt="BanjeeLogo" />
                            <Hidden mdDown>
                            {
                                routing.map((ele) => {
                                    if(ele.id === id){
                                        return(
                                            <Typography variant="h4" style={{marginLeft: '4em',fontFamily:'inherit'}} noWrap component="div">
                                                {ele.name}
                                            </Typography>
                                        )
                                    }else{
                        ...
                        <div style={{display:'flex',justifyContent:'flex-end'}} >
                            <LightTooltip title="Logout">
                                <IconButton style={{paddingTop: '3px',paddingBottom: '3px'}}>
                                    <Link to="/login">
