...
function BusinessList(props) {
	...
	const findBusinessApiCall = React.useCallback(() => {
		findBusinessByUserId(props?.data)
			.then((res) => {
							...
							<Box
								...
								<DataGrid
									...
									onPageSizeChange={(event) => {
										...
										findBusinessApiCall(pagination?.page, event);
									}}
									rowCount={totalEle}
									rows={rows}
									columns={columns}
									...
									onPageChange={(event) => {
										...
										findBusinessApiCall(event, pagination?.pageSize);
									}}
