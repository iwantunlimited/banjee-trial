...
function ReportedUser1(props) {
  ...
  const listApiCall = React.useCallback((data) => {
      console.log(data);
    ReportedUserList(data).then((response) => {
    ...
    if(reportList && rows.length>0){
        return(
            ...
            <Container maxWidth="lg">
                ...
                <Card style={{background: 'white',padding: '25px',border: '1px solid lightgrey',marginTop:'30px',borderRadius:'10px'}}>
                        ...
                        <div className={classes.DataGridBackground}>
                            <DataGrid 
                                ...
                                onPageSizeChange={(event) => {
                                    ...
                                    listApiCall({page:pagination.page, pageSize:event});
                                }}
                                ...
                                // autoPageSize
                                pagination
                                onPageChange={(event) => {listApiCall({page:event, pageSize: pagination.pageSize})}}
        ...
        return(
            <box style={{width: '100%',height: '100vh'}} className="d-flex justify-content-center align-items-center">
                <CircularProgress />
            </box>
        );
    }
