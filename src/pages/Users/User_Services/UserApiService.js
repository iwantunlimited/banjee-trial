...
let listCustomer = (requestLoad) => {
	let url =
		"https://gateway.banjee.org/services/userprofile-service/api/admin/registry/filter";
...
let findCustomer = (requestLoad) => {
	let url =
		"https://gateway.banjee.org/services/userprofile-service/api/admin/findById/" +
		requestLoad;
	let actionCode = "";
	let payload = {};
	let method = "GET";
...
let findReportedCustomer = (requestLoad) => {
    let url = "http://gateway.banjee.org/services/social-connections//api/secured/report/findById/"+ requestLoad;
    let actionCode = "";
    let payload = {};
    let method = 'GET';
    return executeGet(url,actionCode, payload, method,  )
...
let penddingConnectionsList = (requestLoad) => {
	let url =
		"https://gateway.banjee.org/services/userprofile-service/api/registry/filter";
	let actionCode = "ACTION_FILTER_REGISTRY";
	let payload = {
		systemUserIds: [
...
let deleteSubCategory = (requestLoad) => {
    let url = "https://gateway.banjee.org/services/assets-service/api/sub-category/delete/"+ requestLoad;
    let actionCode = "";
    let payload = {};
    let method = 'DELETE';
    return executeGet(url,actionCode, payload, method,  )
